...
class Config:
    ...
    "mongodb+srv://harshdeep_db_user:5aBM8pWh5nXgqOZ4@sih.zkbv6yk.mongodb.net/sih_db?retryWrites=true&w=majority&appName=Sih"
)


    # --- QR Token Config ---
    QR_REFRESH_RATE_SECONDS = 5
    TOKEN_VALIDITY_SECONDS = 10
